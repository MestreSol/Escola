...
public class JFXLoginControle implements Initializable {
	...
	Nativo nativo = new Nativo("Tank", "root", "123", true, false, true, "piloto");
	RedPill redPill = new RedPill("Trinity", "trinity@zion", "trinity", false, true, true, true);
	...
	@FXML public void ok() throws IOException {
		...
		if(contatoInformado.equals(contatoUsuario) && senhaInformada.equals(senhaUsuario)) {
			...
			principalControle.setlUsuarioLogado("Usuário: " + usuario.getNome());

...
/**
 * @author Prof. Ralfe
 * @version Última atualização: 28/08/2017
 */
public class Inicial extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		// O objeto loader possui a referência da classe JFXLoginControle 
		JFXLoginControle loginControle = loader.getController();	
		// E acesso a seus métodos.
		// A referência do palco primário é passada para posterior acesso (fechamento)
